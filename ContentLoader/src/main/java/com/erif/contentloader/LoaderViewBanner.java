...
public class LoaderViewBanner extends View {
    ...
    public LoaderViewBanner(Context context) {
        super(context);
        init(context, null, 0);
    }

    public LoaderViewBanner(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public LoaderViewBanner(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.getTheme().obtainStyledAttributes(
                    attrs, R.styleable.LoaderViewBanner, defStyleAttr, 0
            );
            try {
                peep = typedArray.getInt(R.styleable.LoaderViewBanner_bannerPeep, NONE);
                padding = typedArray.getDimension(R.styleable.LoaderViewBanner_android_padding, 0f);
                peepPaddingVertical = typedArray.getDimension(R.styleable.LoaderViewBanner_peepPaddingVertical, 0f);
                float cornerSize = typedArray.getDimension(R.styleable.LoaderViewBanner_cornerRadius, 0f);
                ...
                color = typedArray.getColor(R.styleable.LoaderViewBanner_android_color, color);
